 ...
 *
 * @implNote It's uncommon to have a web controller implement an interface;
 * ensure users are following the desired input/output for our A We include such design pattern toPI contract, as outlined in the code assessment's README.
 *
